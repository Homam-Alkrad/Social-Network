...
namespace StudentCommunity_DataTraining
{
    public partial class MLModel1
    {
        public const string RetrainFilePath =  @"C:\Users\user\Downloads\dataset 1.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=26,MinimumExampleCountPerLeaf=4,NumberOfTrees=685,MaximumBinCountPerFeature=216,FeatureFraction=0.835183472312328,LearningRate=0.999999776672986,LabelColumnName=@"col1",FeatureColumnName=@"Features",DiskTranspose=false}),labelColumnName: @"col1"))      
