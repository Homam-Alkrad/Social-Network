                ...
                .then(teams => {
                    ...
                    fetch('/api/Rooms')
                        ...
                        .then(data => {
                            ...
                            // Filter out rooms with corresponding teams
                            var filteredData = data.filter(room => !teams.some(team => team.roomId === room.id));

                            for (var i = 0; i < filteredData.length; i++) {
                                self.chatRooms.push(new ChatRoom(filteredData[i].id, filteredData[i].name, filteredData[i].admin));
                            }
