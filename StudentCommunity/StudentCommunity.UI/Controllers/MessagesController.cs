...
namespace Chat.Web.Controllers
{
    ...
    public class MessagesController : ControllerBase
    {
		...
		private readonly IHubContext<ChatHub> _hubContext; // SignalR Hub context for real-time communication

		public MessagesController(CommunityContext context,
            IMapper mapper,
        ...
        [HttpGet("TeamRoom/{roomName}")]
        public IActionResult GetTeamMessages(string roomName)
        {
            var room = _context.Rooms.FirstOrDefault(r => r.Name == roomName);
            if (room == null)
                return BadRequest();
